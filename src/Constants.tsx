...
export const CONTACT_BUTTON_TEXT = 'Say Hello!';
export const CONTACT_CONTENT = "If you'd like to get in touch with me don't hesitate to reach out!";
...
export const CONTACT_BUTTON_COLOR = '#73CCA8';
export const CONTACT_BUTTON_HOVER_COLOR = '#222f33';
export const BORDER_COLOR = '#DBE8D4';
export const TEXT_COLOR = '#DBE8D4';
export const PROJECT_BOX_SHADOW_COLOR = '#414141';
export const FOOTER_BACKGROUND_COLOR = '#2E3445';
export const FOOTER_ICON_TEXT_COLOR = '#73CCA8';
